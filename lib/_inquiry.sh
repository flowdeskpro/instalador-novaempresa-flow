...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do NOVAEMPRESA que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador MultiPremium SWL, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar NOVAEMPRESA\n"
  printf "   [1] Atualizar NOVAEMPRESA\n"
  printf "   [2] Deletar NOVAEMPRESA\n"
  printf "   [3] Bloquear NOVAEMPRESA\n"
  printf "   [4] Desbloquear NOVAEMPRESA\n"
  printf "   [5] Alter. dominio NOVAEMPRESA\n"
  printf "\n"
  read -p "> " option
